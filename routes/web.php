...
Route::middleware('auth')->group(function(){
    ...
    Route::get('requestbooks/create{id}',[RequestbookController::class,'create'])->name('requestbooks.create');
...
Route::middleware('auth','isAdmin')->group(function(){
    ...
    Route::resource('getdonates', Getdonatecontoller::class)->only([
        'index', 'store'
    ]);
    Route::patch('/getdonates/{getdonate}/book/{id}', [Getdonatecontoller::class,'update'])->name('getdonates.update');
    Route::get('/getdonates/{id}/book/{bookid}', [Getdonatecontoller::class,'destroy'])->name('getdonates.destroy');
    Route::get('/issue/{id}/', [Getdonatecontoller::class,'issue'])->name('issue.update');
    Route::get('/return/{id}/book/{bookid}', [Getdonatecontoller::class,'return'])->name('return.update');
    Route::get('/reissue', [Getdonatecontoller::class,'reissue'])->name('reissue');
    Route::get('/reissue/update/{id}', [Getdonatecontoller::class,'reissue_update'])->name('reissue.update');
    Route::get('/reissue/cancel/{id}', [Getdonatecontoller::class,'reissue_cancel'])->name('reissue.cancel');
